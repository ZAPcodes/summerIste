...
import { ArrowLeft, Palette, BookOpen, PlayCircle, ExternalLink, CheckCircle, Clock, Target, ChevronDown, ChevronRight, FileText, Trophy } from "lucide-react";
...
const Design = () => {
  ...
  const QuizSection = ({ week }: { week: Week }) => {
    const { status, loading: scheduleLoading } = useQuizSchedule("design", week.id);
